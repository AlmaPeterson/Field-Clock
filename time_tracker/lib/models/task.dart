class Task {
  ...
  Duration get durationRounded => Duration(minutes: durationMinutesRounded);
  double get earnings => (durationMinutesRounded / 60) * hourlyRate;
  ...
  factory Task.fromMap(Map<String, dynamic> map) => Task(
    ...
    durationMinutesRounded: map['duration_minutes_rounded'] ?? 0,
    hourlyRate: map['hourly_rate'] ?? 0.0,
  );

  Task copyWith({
    int? id, String? name, String? notes,
    DateTime? endTime, String? endPhoto, String? endLocation,
    int? durationMinutesRaw, int? durationMinutesRounded,
    String? startPhoto, String? startLocation, double? hourlyRate,
  }) => Task(
    id: id ?? this.id,
    workDayId: workDayId,
    name: name ?? this.name,
    ...
    durationMinutesRaw: durationMinutesRaw ?? this.durationMinutesRaw,
    durationMinutesRounded: durationMinutesRounded ?? this.durationMinutesRounded,
